    ...
    render: async () => {
      ...
      return `
        ...
        <div class="sp-section">
          ...
          <div class="sp-row"><span>Target</span><span class="sp-val small">ops/snapshots/${cid.slice(0,8)}…html</span></div>
...
function wireButtons() {
  ...
  on('btn-snapshot-push', async () => {
    ...
    const path = `ops/snapshots/Sentinel.Tokens.${cid.slice(0,8)}.${ts}.html`;
