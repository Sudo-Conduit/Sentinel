...
(function(root, factory)
{
    ...
    {
        root.Environment = factory(root.BaseClassX);
    }
}(typeof self !== 'undefined' ? self : this, function(BaseClassX)
{
    ...
    if (!BaseClassX)
    {
        throw new Error('Environment requires BaseClassX to be loaded first');
    }
    ...
    class Environment extends BaseClassX
    {
        ...
        static description = 'Machine-end "read environment" step -- host facts (runtime, platform, cores, memory) BIOS cannot know without asking.';
        ...
        /**
         * Detect host environment facts (browser navigator, or Node process/os).
         * @returns {Environment} a fresh instance describing the current host
         */
        static detect()
        {
